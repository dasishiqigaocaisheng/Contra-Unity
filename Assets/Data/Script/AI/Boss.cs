    ...
    public class Boss : NetworkBehaviour
    {
        ...
        void Start()
        {
            ...
            fsm.AddTransferPath("Sleep", "LeftFire",
                ...
                transfer: (x) => NetPlayer.P1.PlaySound(SoundManager.SoundType.Other, "Boss", false));
        ...
        {
            if (_HP != 0 && collision.gameObject.layer == LayerMask.NameToLayer("PlayerBullet"))
            {
        ...
        [ClientRpc]
        public void SetBrokenActive(string name, bool active)
        {
        ...
        public void _Broken()
        {
            ...
            SoundManager.Inst.Play(SoundManager.SoundType.Effect, "Effect4", false);
        }
